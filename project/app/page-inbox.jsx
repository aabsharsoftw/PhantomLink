...
function InboxPage() {
  ...
  const chColor = { wa:'#22C55E', mail:'#6366F1', sms:'#F59E0B' };
  ...
  return (
    <>
      <Topbar
        title="Conversations" subtitle="23 open · 4 assigned to you"
        actions={<>
            ...
            {convs.map(c => {
              ...
              return (
                <div key={c.id} className={`conv-row${c.active?' active':''}`}>
                  <div className="avatar" style={{background:c.color, position:'relative'}}>
                    {c.avatar}
        ...
        <section className="col" style={{minHeight:0}}>
          <div className="row gap-3" style={{padding:'12px 18px', borderBottom:'1px solid var(--border)'}}>
            ...
            <div className="col flex-1" style={{lineHeight:1.3}}>
              <div className="row gap-2"><span style={{fontWeight:600, fontSize:14}}>Sana Iqbal</span><span className="pill green"><I.wa size={10}/> WhatsApp</span><span className="tag-chip">#hot-lead</span></div>
