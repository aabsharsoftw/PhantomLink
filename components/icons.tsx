...
type IconProps = Omit<SVGProps<SVGSVGElement>, 'stroke' | 'd'> & { size?: number; stroke?: number }

function Icon({ d, size = 18, stroke = 1.75, fill = 'none', children, ...rest }: IconProps & { d?: string | string[] }) {
  return (
    <svg
...
export const I: Record<string, (p: IconProps) => ReactElement> = {
  ...
  contact: (p) => <Icon {...p}><circle cx="12" cy="8" r="4"/><path d="M4 21c0-4.4 3.6-8 8-8s8 3.6 8 8"/></Icon>,
  pipeline:(p) => <Icon {...p} d={['M4 5h5v14H4z','M10.5 9h5v10h-5z','M17 7h3v12h-3z']} />,
  campaign:(p) => <Icon {...p} d={['M3 11l18-7v16L3 13z','M11 19v3','M3 11v2']} />,
  bot:     (p) => <Icon {...p}><rect x="4" y="7" width="16" height="12" rx="2"/><path d="M12 3v4M9 13h.01M15 13h.01M9 17h6"/></Icon>,
  ...
  wa:      (p) => <Icon {...p}><path d="M3 21l1.6-5A8 8 0 1 1 8 19l-5 2"/><path d="M9 9.5c0 3 2.5 5.5 5.5 5.5l1.5-1.5-2-1-1 1c-1 0-2-1-2-2l1-1-1-2L10 8c-.5 0-1 .5-1 1.5z"/></Icon>,
  ...
  zap:     (p) => <Icon {...p} d="M13 2L4 14h7l-1 8 9-12h-7z" fill="currentColor" stroke={0} />,
  ...
  flow:    (p) => <Icon {...p}><rect x="3" y="3" width="6" height="4" rx="1"/><rect x="15" y="9" width="6" height="4" rx="1"/><rect x="3" y="17" width="6" height="4" rx="1"/><path d="M9 5h2a2 2 0 0 1 2 2v4M9 19h2a2 2 0 0 0 2-2v-4M13 11h2"/></Icon>,
  ...
  fb:      (p) => <Icon {...p} d="M14 22V12h3l1-4h-4V6c0-1 .3-2 2-2h2V0h-3c-3 0-5 2-5 5v3H7v4h3v10z" fill="currentColor" stroke={0} />,
  ...
  play:    (p) => <Icon {...p} d="M6 4l14 8-14 8z" fill="currentColor" stroke={0} />,
  pause:   (p) => <Icon {...p} d={['M6 4h4v16H6z','M14 4h4v16h-4z']} fill="currentColor" stroke={0} />,
