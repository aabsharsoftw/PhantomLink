...
const camps = [
  { name: 'Spring Promo 2026',  ch: 'mail', status: 'sent',      sent: 4210, open: 38.2, click: 9.4,  owner: 'RA', date: 'Apr 24' },
  { name: 'Cart abandon · WA',  ch: 'wa',   status: 'running',   sent: 1820, open: 92.1, click: 14.2, owner: 'AD', date: 'Apr 22' },
  { name: 'OTP welcome SMS',    ch: 'sms',  status: 'running',   sent: 3940, open: 0,    click: 0,    owner: 'NK', date: 'Apr 21' },
  { name: 'Renewal reminder',   ch: 'mail', status: 'sent',      sent: 612,  open: 54.0, click: 22.1, owner: 'RA', date: 'Apr 18' },
  { name: 'Webinar invite',     ch: 'mail', status: 'sent',      sent: 2140, open: 41.8, click: 11.0, owner: 'AD', date: 'Apr 15' },
  { name: 'May launch teaser',  ch: 'mail', status: 'scheduled', sent: 0,    open: 0,    click: 0,    owner: 'RA', date: 'May 3' },
  { name: 'Reactivation · WA',  ch: 'wa',   status: 'draft',     sent: 0,    open: 0,    click: 0,    owner: 'NK', date: '—' },
]
...
export default function CampaignsPage() {
  return (
    <>
      <Topbar
        title="Campaigns"
        subtitle={`${camps.length} campaigns · 2 running`}
        actions={<>
