...
const tagColor: Record<string, string> = {
  'hot-lead': 'red', 'mumbai': 'blue', 'enterprise': 'violet',
  'newsletter': '', 'demo-booked': 'green', 'agency': 'amber',
  'trial': 'teal', 'intl': 'pink', 'churned': '',
}
...
export default function ContactsPage() {
  return (
    <>
      <Topbar
        title="Contacts"
        subtitle={`${contacts.length} of 12,482 visible`}
        actions={<>
